...
void displayBooks() {
    ...
    if (bookCount == 0) {
  	...
  	cout << "\nBook Details : " << endl;
	cout << left << setw(15) << "ISBN" << setw(40) << "Title" << setw(20) << "Author" << setw(10) << "Price" << setw(10) << "Stock" << endl;

	cout << fixed << setprecision(2);

	for (int i = 0; i < bookCount; i++) {
        cout << left << setw(15) << inventory[i].isbn
             << setw(40) << inventory[i].title
